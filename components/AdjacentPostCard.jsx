...
const AdjacentPostCard = ({ post, position }) => (
  <>
    <div className="transition duration-500 hover:scale-110 absolute rounded-lg bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-72" style={{ backgroundImage: `url('${post.featuredImage.url}')` }} />
